class User < ApplicationRecord
  ...
  validates :last_name, presence: true,
                        format: { with: /\A[[ぁ-んァ-ヶ一-龥々]]+\z/, message: 'Last name is invalid. Input full-width characters' }
  validates :first_name, presence: true,
                         format: { with: /\A[[ぁ-んァ-ヶ一-龥々]]+\z/, message: 'First name is invalid. Input full-width characters' }
